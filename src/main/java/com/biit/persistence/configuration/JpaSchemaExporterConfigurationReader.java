...
public class JpaSchemaExporterConfigurationReader extends ConfigurationReader {
    ...
    private static JpaSchemaExporterConfigurationReader instance;

    private JpaSchemaExporterConfigurationReader() {
        super();
    ...
    public static JpaSchemaExporterConfigurationReader getInstance() {
        if (instance == null) {
            synchronized (JpaSchemaExporterConfigurationReader.class) {
                if (instance == null) {
                    instance = new JpaSchemaExporterConfigurationReader();
                }
            }
        }
        return instance;
